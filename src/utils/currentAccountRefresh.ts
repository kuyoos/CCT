...
export type CurrentAccountRefreshPlatform = 'codex';

export const CURRENT_ACCOUNT_REFRESH_PLATFORMS: CurrentAccountRefreshPlatform[] = ['codex'];
...
function normalizeCurrentAccountRefreshMinutesMap(
  ...
  return {
    codex: sanitizeCurrentAccountRefreshMinutes(raw.codex),
  };
}
